---
title: DafnyRuntimeSystemModule.cs — C# System Module Reference
type: reference
...
# DafnyRuntimeSystemModule.cs — C# System Module Reference

Source: bundled with Dafny 4.11.0. 3,686 lines.
This defines the `_System` module types in C# that translated Dafny code references.
