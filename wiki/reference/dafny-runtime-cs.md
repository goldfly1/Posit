---
title: DafnyRuntime.cs — C# Runtime Reference
type: reference
tags: [csharp, dafny, runtime, reference]
component: dafny
version: 4.11.0
last_updated: 2026-08-07
---

# DafnyRuntime.cs — C# Runtime Reference

Source: bundled with Dafny 4.11.0. 1,963 lines.
This is the C# runtime that translated Dafny code depends on.
Use `--include-runtime` when translating to embed this in the output.
