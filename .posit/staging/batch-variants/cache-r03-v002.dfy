...
method Store(cache: map<int, string>, ttl: map<int, int>, size: map<int, int>, key: int, value: string, time: int, sz: int) returns (newCache: map<int, string>, newTtl: map<int, int>, newSize: map<int, int>)
