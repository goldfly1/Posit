...
method PublishStateChangeByPriority(subs: seq<Subscription>, eventName: string, minPriority: int) returns (delivered: int)
...
method SubscribeStateChange(subs: seq<Subscription>, sid: int, en: string, prio: int) returns (r: Result<seq<Subscription>>)
  requires NoDupSubs(subs)
