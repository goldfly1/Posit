...
method PublishTimerByPriority(subs: seq<Subscription>, eventName: string, minPriority: int) returns (delivered: int)
...
method SubscribeTimer(subs: seq<Subscription>, sid: int, en: string, prio: int) returns (r: Result<seq<Subscription>>)
  requires NoDupSubs(subs)
