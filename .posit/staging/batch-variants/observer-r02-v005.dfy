...
method PublishMessageFiltered(subs: seq<Subscription>, eventName: string, eventFilter: string) returns (delivered: int)
...
method SubscribeMessage(subs: seq<Subscription>, sid: int, en: string) returns (r: Result<seq<Subscription>>)
  requires NoDupSubs(subs)
