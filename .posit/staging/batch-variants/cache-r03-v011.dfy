...
method Store(cache: map<int, string>, freq: map<int, int>, ttl: map<int, int>, size: map<int, int>, key: int, value: string, time: int, sz: int, maxEntries: int) returns (newCache: map<int, string>, newFreq: map<int, int>, newTtl: map<int, int>, newSize: map<int, int>)
