...
method PublishDataUpdateByPriority(subs: seq<Subscription>, eventName: string, minPriority: int) returns (delivered: int)
...
method SubscribeDataUpdate(subs: seq<Subscription>, sid: int, en: string, prio: int) returns (r: Result<seq<Subscription>>)
  requires NoDupSubs(subs)
