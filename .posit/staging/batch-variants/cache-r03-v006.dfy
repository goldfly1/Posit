...
method Store(cache: map<int, string>, order: seq<int>, ttl: map<int, int>, size: map<int, int>, key: int, value: string, time: int, sz: int) returns (newCache: map<int, string>, newOrder: seq<int>, newTtl: map<int, int>, newSize: map<int, int>)
