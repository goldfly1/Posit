...
method PublishTimerFiltered(subs: seq<Subscription>, eventName: string, eventFilter: string) returns (delivered: int)
...
method SubscribeTimer(subs: seq<Subscription>, sid: int, en: string) returns (r: Result<seq<Subscription>>)
  requires NoDupSubs(subs)
